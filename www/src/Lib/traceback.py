        ...
        if frame_summary.line:
            ...
            if (
                ...
                if frame_summary.lineno == frame_summary.end_lineno:
                    # CS Academy code change to avoid importing contextlib
...
class _Anchors(object):
    def __init__(self, left_end_offset, right_start_offset, primary_char='~', secondary_char='^'):
...
# Replaced with the above _Anchors class by CS Academy to avoid importing collections
...
class TracebackException:
    ...
    def format_exception_only(self):
        ...
        # Fuctionality removed by CS Academy to prevent importing collections
